...
<html>
    ...
    <body>
        ...
        <div class="banner-head">
            <img src="img/tesla_3/5.jpg" alt="Главный баннер">
            <div class="banner-head-text">
                <h2>MODEL 3</h2>
            </div>
        </div>
        <div class="description">
            <h3><?=$dict['SPECIFICATIONS']?> Tesla Model 3</h3>
        </div>
        <div class="specifications">
            <div>
                <p><span><?=$dict['BATTERY']?></span><br>75 <?=$dict['KW*H']?></p>
                <p><span><?=$dict['POVER RESERVE']?></span><br>499 <?=$dict['KM']?></p>
                <p><span><?=$dict['DRIVE UNIT']?></span><br>AWD</p>
            </div>
            <div>
                <p><span><?=$dict['BOOST']?></span><br>3,5 <?=$dict['SECOND']?> 0-100 <?=$dict['KM/H']?></p>
                <p><span><?=$dict['SEAT']?></span><br>5</p>
                <p><span><?=$dict['VOLUME']?></span><br>425 <?=$dict['LITER']?></p>
            </div>
            <div>
