...
<html>
    ...
    <body>
        ...
        <div class="banner-head">
            <img src="img/roadster/1.jpg" alt="Главный баннер">
            <div class="banner-head-text">
                <h2>ROADSTER</h2>
            </div>
        </div>
        <div class="description">
            <h3><?=$dict['SPECIFICATIONS']?> Tesla Roadster</h3>
        </div>
        <div class="specifications">
            <div>
                <p><span><?=$dict['BATTERY']?></span><br>2000 <?=$dict['KW*H']?></p>
                <p><span><?=$dict['POVER RESERVE']?></span><br>998 <?=$dict['KM']?></p>
            </div>
            <div>
                <p><span><?=$dict['BOOST']?></span><br>1,9 <?=$dict['SECOND']?> 0-100 <?=$dict['KM/H']?></p>
                <p><span><?=$dict['SEAT']?></span><br>2 + 2</p>
            </div>
            <div>
                <p><span><?=$dict['MAX SPEED']?></span><br>402 <?=$dict['KM/H']?></p>
                <p><span><?=$dict['DISPLAY']?></span><br>15-<?=$dict['CENTRAL SCREEN']?></p>
            </div>
        </div>
        <footer>
            <table class="model">
