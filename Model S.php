...
<html>
    ...
    <body>
        ...
        <div class="banner-head">
            <img src="img/tesla_s/tesla_s2.jpg" alt="Главный баннер">
            <div class="banner-head-text">
                <h2>MODEL S</h2>
            </div>
        </div>
        <div class="description">
            <h3><?=$dict['SPECIFICATIONS']?> Tesla Model S</h3>
        </div>
        <div class="specifications">
            <div>
                <p><span><?=$dict['BATTERY']?></span><br>100 <?=$dict['KW*H']?></p>
                <p><span><?=$dict['POVER RESERVE']?></span><br>613 <?=$dict['KM']?></p>
                <p><span><?=$dict['DRIVE UNIT']?></span><br>AWD</p>
                <p><span><?=$dict['WHEELS']?></span><br>19” / 21”</p>
            </div>
            <div>
                <p><span><?=$dict['BOOST']?></span><br>2,7 <?=$dict['SECOND']?> 0-100 <?=$dict['KM/H']?></p>
                <p><span><?=$dict['ENGINE POWER']?></span><br> 762 <?=$dict['H.P']?></p>
                <p><span><?=$dict['TORQUE']?></span><br>967 Н·м</p>
                <p><span><?=$dict['WEIGHT']?></span><br>2 250 <?=$dict['KG']?></p>
            </div>
            <div>
                <p><span><?=$dict['MAX SPEED']?></span><br>250 <?=$dict['KM/H']?></p>
                <p><span><?=$dict['VOLUME']?></span><br>894 <?=$dict['LITER']?></p>
                <p><span><?=$dict['SEAT']?></span><br>5 + 2</p>
